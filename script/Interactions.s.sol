...
contract FundSubscription is Script, CodeConst {
        ...
        public
    {
        ...
        console.log("Subscription funded with: ", FUND_AMOUNT * 100);
    }
...
contract AddConsumer is Script {
    function addConsumerUsingConfig(address mostRecentlyDeployed) public {
        ...
        address vrfCoordinator = helperConfig.getConfig().vrfCoordinator;
        address account = helperConfig.getConfig().account;
        addConsumer(address(mostRecentlyDeployed), vrfCoordinator, subId, account);
    }
    ...
    function run() public {
        address mostRecentlyDeployd = DevOpsTools.get_most_recent_deployment("Raffle", block.chainid);
        addConsumerUsingConfig(mostRecentlyDeployd);
    }
}
