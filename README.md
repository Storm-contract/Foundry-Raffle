...
This is a test project was created to make a provably fair raffle.
...
```
git clone https://github.com/Storm-contract/Foundry-Raffle
...
```
Also you'll be recuired to have foundry devops and solmate libraries.
To quickly install them run this comands:
```
